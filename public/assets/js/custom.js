...
var GardenZone = function(){
	...
	var handleContactPopup = function(){
		...
		console.log(phone)
		var popup = `<div class="contant-no-area">
						<div class="contact-number label-contact">
						<h5>Ada Pertanyaan ?</h5>
						<h6>`+phone+`</h6>
					</div>
					<div class="contact-name label-visitor">
						<span>Jumlah Visitor <br></span>
						<span class="count-visit">`+visitor+`</span>
					</div>`;
