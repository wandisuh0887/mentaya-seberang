...
@section('content')
    <div class="content-wrapper p-3">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="form-horizontal" action="{{ route('pemberdayaan.update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('pemberdayaan.index') }}" class="btn btn-default">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
