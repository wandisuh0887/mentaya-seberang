                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7 input-group">
                                            <textarea class="form-input" name="short_description" rows="4" cols="100" required>{{ old('short_description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-3 col-form-label">Rekomendasi ukuran file : <span class="text-danger">700 x 500</span> </label>
                                    </div>
                                </div>
                            </div>
                        </div>
