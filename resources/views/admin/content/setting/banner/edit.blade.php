                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7 input-group">
                                            <textarea class="form-input" name="short_content" rows="4" cols="100">{{ $banner->short_content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2 input-group">
                                            <input type="number" class="form-control" id="sort" name="sort" value="{{ $banner->sort }}" required/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row {{ $banner->file ? '':'d-none' }}">
                                        <label for="category_detail_id" class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-5 input-group">
                                            <img style="width: 250px;" class="image" src="{{ $banner->file_url }}" alt="{{ $banner->title }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
