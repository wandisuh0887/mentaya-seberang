...
@section('content')
    <div class="content-wrapper p-3">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="form-horizontal" action="{{ route('sarpras.update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9" id="item_availability_date" data-target-input="nearest">
                                            <textarea id="summernote" name="content">{{ $sarpras->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row d-none">
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('sarpras.index') }}" class="btn btn-default">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
