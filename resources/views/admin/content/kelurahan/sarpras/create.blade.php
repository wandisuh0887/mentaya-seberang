...
@section('content')
    <div class="content-wrapper p-3">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="form-horizontal" action="{{ route('sarpras.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5 input-group">
                                            <input type="text" class="form-control" id="title" name="title" value="Sarana Prasarana" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row d-none">
                                        ...
                                        <label class="col-sm-3 col-form-label d-none">Rekomendasi ukuran file : <span class="text-danger">428 x 670</span> </label>
                                    </div>
                                </div>
                            </div>
                        </div>
