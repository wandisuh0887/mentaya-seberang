...
@section('content')
    <div class="content-wrapper p-3">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="form-horizontal" action="{{ route('visi.update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5 input-group">
                                            <input type="text" class="form-control" id="title" name="title" value="Visi Misi" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9" id="item_availability_date" data-target-input="nearest">
                                            <textarea id="summernote" name="content">{{ $visi->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row d-none">
                        ...
                        <div class="col-md-12">
                            <div class="card card-info">
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('visi.index') }}" class="btn btn-default">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
