                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5 input-group">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $visi->title }}" readonly/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-9" id="item_availability_date" data-target-input="nearest">
                                        <textarea id="summernote" name="content" readonly>{{ $visi->content }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row d-none">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        @if($visi->file)
                                        <img style="width: 250px;" class="image" src="{{ $visi->file_url }}" alt="{{ $visi->title }}">
                                        @else -
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-footer text-center">
                                <a href="{{ route('visi.edit', $visi->id) }}" class="btn btn-primary">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
